...
class VolumeConfigurationsApi(object):
    ...
    def create_volume_configuration(self, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_volume_configuration_with_http_info(body, **kwargs)  # noqa: E501
            return data
    ...
    def create_volume_configuration_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_volume_configuration`")  # noqa: E501
    ...
    def delete_volume_configuration(self, volume_configuration_name, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_volume_configuration_with_http_info(volume_configuration_name, **kwargs)  # noqa: E501
            return data
    ...
    def delete_volume_configuration_with_http_info(self, volume_configuration_name, **kwargs):  # noqa: E501
        ...
        all_params = ['volume_configuration_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('volume_configuration_name' not in params or
                params['volume_configuration_name'] is None):
            raise ValueError("Missing the required parameter `volume_configuration_name` when calling `delete_volume_configuration`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'volume_configuration_name' in params:
            path_params['volumeConfigurationName'] = params['volume_configuration_name']  # noqa: E501
    ...
    def get_volume_configuration(self, volume_configuration_name, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_volume_configuration_with_http_info(volume_configuration_name, **kwargs)  # noqa: E501
            return data
    ...
    def get_volume_configuration_with_http_info(self, volume_configuration_name, **kwargs):  # noqa: E501
        ...
        if ('volume_configuration_name' not in params or
                params['volume_configuration_name'] is None):
            raise ValueError("Missing the required parameter `volume_configuration_name` when calling `get_volume_configuration`")  # noqa: E501
    ...
    def list_volume_configurations(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_volume_configurations_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def list_volume_configurations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['online_status', 'page_size', 'page_token', 'include']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'page_size' in params and params['page_size'] > 1000:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `list_volume_configurations`, must be a value less than or equal to `1000`")  # noqa: E501
        if 'page_size' in params and params['page_size'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `list_volume_configurations`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        if 'online_status' in params:
            query_params.append(('onlineStatus', params['online_status']))  # noqa: E501
    ...
    def validate_volume_configuration(self, volume_configuration_name, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.validate_volume_configuration_with_http_info(volume_configuration_name, **kwargs)  # noqa: E501
            return data
    ...
    def validate_volume_configuration_with_http_info(self, volume_configuration_name, **kwargs):  # noqa: E501
        ...
        if ('volume_configuration_name' not in params or
                params['volume_configuration_name'] is None):
            raise ValueError("Missing the required parameter `volume_configuration_name` when calling `validate_volume_configuration`")  # noqa: E501
