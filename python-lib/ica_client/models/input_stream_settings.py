...
class InputStreamSettings(object):
    ...
    def __init__(self, access_pattern='sequential', cache_size_gb=50, block_size_mb=32.0, prefetch_blocks=32):  # noqa: E501
        """InputStreamSettings - a model defined in Swagger"""  # noqa: E501
    ...
    def cache_size_gb(self, cache_size_gb):
        ...
        :type: int
        """
        if cache_size_gb is not None and cache_size_gb > 10000:  # noqa: E501
            raise ValueError("Invalid value for `cache_size_gb`, must be a value less than or equal to `10000`")  # noqa: E501
        if cache_size_gb is not None and cache_size_gb < 50:  # noqa: E501
    ...
    def block_size_mb(self, block_size_mb):
        ...
        :type: float
        """
        if block_size_mb is not None and block_size_mb > 1024:  # noqa: E501
            raise ValueError("Invalid value for `block_size_mb`, must be a value less than or equal to `1024`")  # noqa: E501
        if block_size_mb is not None and block_size_mb < 0:  # noqa: E501
    ...
    def prefetch_blocks(self, prefetch_blocks):
        ...
        :type: int
        """
        if prefetch_blocks is not None and prefetch_blocks > 64:  # noqa: E501
            raise ValueError("Invalid value for `prefetch_blocks`, must be a value less than or equal to `64`")  # noqa: E501
        if prefetch_blocks is not None and prefetch_blocks < 0:  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InputStreamSettings, dict):
