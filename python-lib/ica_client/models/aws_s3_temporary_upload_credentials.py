...
class AwsS3TemporaryUploadCredentials(object):
    ...
    def __init__(self, access_key_id=None, secret_access_key=None, session_token=None, region=None, bucket_name=None, key_prefix=None, expiration_date=None, service_url=None):  # noqa: E501
        """AwsS3TemporaryUploadCredentials - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AwsS3TemporaryUploadCredentials, dict):
