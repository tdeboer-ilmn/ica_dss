...
class TaskRunSummary(object):
    ...
    def __init__(self, id=None, href=None, urn=None, name=None, description=None, status='Pending', status_details=None, task_version_summary=None, acl=None, tenant_id=None, sub_tenant_id=None, created_by=None, time_created=None, modified_by=None, time_modified=None):  # noqa: E501
        """TaskRunSummary - a model defined in Swagger"""  # noqa: E501
    ...
    def status_details(self, status_details):
        ...
        :type: str
        """
        if status_details is not None and len(status_details) > 4096:
            raise ValueError("Invalid value for `status_details`, length must be less than or equal to `4096`")  # noqa: E501
        if status_details is not None and len(status_details) < 0:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskRunSummary, dict):
