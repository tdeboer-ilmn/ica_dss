...
class Subscription(object):
    ...
    def __init__(self, id=None, urn=None, type=None, actions=None, filter_expression=None, name=None, description=None, delivery_target=None, match_identities=None, acl=None, tenant_id=None, created_by_user_id=None, time_created=None, deleted_by_user_id=None, time_deleted=None, is_deleted=None):  # noqa: E501
