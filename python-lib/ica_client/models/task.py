...
class Task(object):
    ...
    def __init__(self, id=None, href=None, urn=None, name=None, description=None, task_versions=None, acl=None, tenant_id=None, sub_tenant_id=None, created_by=None, time_created=None, modified_by=None, time_modified=None):  # noqa: E501
