...
class TaskVersion(object):
    ...
    def __init__(self, id=None, href=None, urn=None, version=None, description=None, execution=None, acl=None, tenant_id=None, sub_tenant_id=None, created_by=None, time_created=None, modified_by=None, time_modified=None):  # noqa: E501
        """TaskVersion - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TaskVersion, dict):
