...
class TokenDetailResponse(object):
    ...
    def __init__(self, uid=None, name=None, username=None, current_workgroup=None, tid=None, acls=None, domain=None):  # noqa: E501
        """TokenDetailResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokenDetailResponse, dict):
