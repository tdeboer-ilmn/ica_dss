...
class WorkflowConnection(object):
    ...
    def __init__(self, name=None, type=None, host=None, host_validation_regex=None, credentials=None, options=None, auto_disable_url=None, auto_disable_http_method=None):  # noqa: E501
        """WorkflowConnection - a model defined in Swagger"""  # noqa: E501
    ...
    def host(self, host):
        ...
        :type: str
        """
        if host is not None and len(host) > 1024:
    ...
    def host_validation_regex(self, host_validation_regex):
        ...
        :type: str
        """
        if host_validation_regex is not None and len(host_validation_regex) > 100:
            raise ValueError("Invalid value for `host_validation_regex`, length must be less than or equal to `100`")  # noqa: E501
        if host_validation_regex is not None and len(host_validation_regex) < 0:
    ...
    def auto_disable_url(self, auto_disable_url):
        ...
        :type: str
        """
        if auto_disable_url is not None and len(auto_disable_url) > 1024:
            raise ValueError("Invalid value for `auto_disable_url`, length must be less than or equal to `1024`")  # noqa: E501
        if auto_disable_url is not None and len(auto_disable_url) < 0:
    ...
    def auto_disable_http_method(self, auto_disable_http_method):
        ...
        :type: str
        """
        if auto_disable_http_method is not None and len(auto_disable_http_method) > 10:
            raise ValueError("Invalid value for `auto_disable_http_method`, length must be less than or equal to `10`")  # noqa: E501
        if auto_disable_http_method is not None and len(auto_disable_http_method) < 0:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WorkflowConnection, dict):
