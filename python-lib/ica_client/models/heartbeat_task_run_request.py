...
class HeartbeatTaskRunRequest(object):
    ...
    def __init__(self, last_heartbeat=None, pod_name=None, pod_uid=None, pod_hardware_details=None, job_retry_count=None, nonce=None, container_status=None):  # noqa: E501
        """HeartbeatTaskRunRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HeartbeatTaskRunRequest, dict):
