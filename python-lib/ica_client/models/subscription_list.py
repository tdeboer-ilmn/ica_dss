...
class SubscriptionList(object):
    ...
    def __init__(self, items=None, item_count=None, first_page_token=None, next_page_token=None, prev_page_token=None, last_page_token=None, total_item_count=None, total_page_count=None, sorted_by=None, sort_direction=None):  # noqa: E501
