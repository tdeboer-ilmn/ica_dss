...
class WorkflowRunHistoryEvent(object):
    ...
    def __init__(self, name=None, event_id=None, previous_event_id=None, event_type=None, timestamp=None, event_details=None):  # noqa: E501
        """WorkflowRunHistoryEvent - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WorkflowRunHistoryEvent, dict):
